...
class LogoMotioin extends PureComponent {
  static propTypes = {
  ...
  static defaultProps = {
    image: 'http://localhost:8000/logo-wzj.png', // 'https://zos.alipayobjects.com/rmsportal/gsRUrUdxeGNDVfO.svg',
    w: 300,
    h: 300,
    pixSize: 20,
    pointSizeMin: 10,
  ...
  render() {
    return (
      <div className={styles.logoGatherWrapper}>
        <canvas id="canvas" />
        <TweenOne
